            ...
            return (
              <article
                ...
                className={`relative rounded-2xl p-8 flex flex-col justify-between transition-all duration-300 border ${
                  plan.isPopular
                    ? 'bg-brand-teal text-brand-white md:-translate-y-4 hover:-translate-y-6 shadow-xl hover:shadow-2xl border-brand-teal'
                    : 'bg-brand-white text-brand-dark shadow-xs border-brand-dark/10 hover:-translate-y-2 hover:shadow-lg'
