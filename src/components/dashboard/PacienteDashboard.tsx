...
import { Search, User, ArrowRight, Stethoscope, Heart, Baby, Brain, Activity, Sparkles, HeartHandshake } from 'lucide-react';
...
export default function PacienteDashboard({ user }: PacienteDashboardProps) {
  return (
